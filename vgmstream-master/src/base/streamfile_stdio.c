...
#if !defined (_MSC_VER) && !defined (__ANDROID__) && !defined (__APPLE__) && !defined (__3DS__)
...
#elif defined(XBMC) || defined(__EMSCRIPTEN__) || defined (__ANDROID__) || defined(__3DS__)
    /* may depend on version; 3DS/newlib use plain fseek/ftell */
    #define fopen_v fopen
    #define fseek_v fseek
    #define ftell_v ftell
